...
public class YamlConfig implements ConfigurationAdapter {
	...
	private <T> T get(String path, T def, Map<String, Object> submap) {
		return get(path, def, submap, true);
	}

	@SuppressWarnings("unchecked")
	private <T> T get(String path, T def, Map<String, Object> submap, boolean save) {
		...
		if (index == -1) {
			...
			Map<String, Object> sub = (Map<String, Object>) submap.get(first);
			if (sub == null && save) {
	...
	public Collection<ListenerInfo> getListeners() {
		Collection<Map<String, Object>> base = get("listeners", Arrays.asList(new HashMap<String, Object>()));
