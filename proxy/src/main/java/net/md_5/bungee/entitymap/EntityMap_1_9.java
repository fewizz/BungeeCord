...
class EntityMap_1_9 extends EntityMap
{
    ...
    EntityMap_1_9()
    {
        ...
        addRewrite( 0x49, Direction.TO_CLIENT, true ); // Collect Item : PacketPlayOutCollect
        addRewrite( 0x4A, Direction.TO_CLIENT, true ); // Entity Teleport : PacketPlayOutEntityTeleport
        addRewrite( 0x4B, Direction.TO_CLIENT, true ); // Entity Properties : PacketPlayOutUpdateAttributes
        addRewrite( 0x4C, Direction.TO_CLIENT, true ); // Entity Effect : PacketPlayOutEntityEffect
