...
public class ForgeClientHandler {
	...
	/**
	 * Resets the client handshake state to HELLO, and, if we know the handshake has
	 * been completed before, send the reset packet.
	 */
	 ...
	 *
	 * @param modList The {@link PluginMessage} to send to the client containing the
	 *                mod list.
	 ...
	 *
	 * @param idList The {@link PluginMessage} to send to the client containing the
	 *               ID list.
	 * @throws IllegalArgumentException Thrown if the {@link PluginMessage} was not
	 *                                  as expected.
	 */
	 ...
	 * token is included in the initial handshake. We can use that to determine if
	 * the user is a Forge 1.8 user.
	 *
