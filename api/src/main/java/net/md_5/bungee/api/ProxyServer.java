...
public abstract class ProxyServer
{
     ...
     */
    @Deprecated
    public abstract Protocol getProtocolVersion();
     ...
     */
    public abstract ServerInfo constructServerInfo(String name, InetSocketAddress address, String motd, boolean restricted, Boolean ipForward, Boolean forgeSupport);
